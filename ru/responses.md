...
Интеграция вашего карьерного сайта с нашей платформой публикации вакансий и сбора откликов — платная услуга, она требует работы со стороны Хантфлоу. Ее стоимость — 110 000 рублей ($1590 или €1450), единоразово. Возможно, вам будет достаточно  [базовых методов API и вебхуков](https://github.com/huntflow/api), с помощью которых вы сможете сделать интеграцию без привлечения разработчиков Хантфлоу.

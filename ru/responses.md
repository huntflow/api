...
Подключение вашего карьерного сайта к платформе публикации вакансий и сбора откликов Хантфлоу делает работу удобной для рекрутеров: они контролируют когда опубликовать, а когда снять вакансию с публикации и в любой момент могут отредактировать ее — все это прямо из Хантфлоу.

Это платная услуга: после предоставления вашими разработчиками интеграционных методов, наша команда должна будет подключить его к вашему Хантфлоу. Стоимость подключения каждого карьерного сайта: 291 000 руб (€4 750, $6 000, 2 475 000 тенге, 2 475 000 армянских драм),  оплата единоразовая.
...
Карьерный сайт должен успеть обработать запрос и вернуть результат за 15 секунд. В противном случае, попытка публикации будет считаться неуспешной.
